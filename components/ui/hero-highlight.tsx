...
export const HeroHighlight = ({
  ...
  const dotPatterns = {
    light: {
      base: `url("data:image/svg+xml;charset=utf-8,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 32 32' width='16' height='16' fill='none'%3E%3Ccircle fill='%23d4d4d4' id='pattern-circle' cx='10' cy='10' r='2.5'%3E%3C/circle%3E%3C/svg%3E")`,
    ...
    dark: {
      base: `url("data:image/svg+xml;charset=utf-8,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 32 32' width='16' height='16' fill='none'%3E%3Ccircle fill='%23404040' id='pattern-circle' cx='10' cy='10' r='2.5'%3E%3C/circle%3E%3C/svg%3E")`,
  ...
  return (
    <div
      className={cn(
        "group relative flex w-full items-center justify-center overflow-hidden rounded-3xl border border-border/60 bg-card/80 shadow-sm",
        containerClassName,
      )}
    ...
    >
      <div
        ...
        style={{ backgroundImage: dotPatterns.light.base }}
      />
      <div
        className="pointer-events-none absolute inset-0 hidden opacity-80 dark:block"
        style={{ backgroundImage: dotPatterns.dark.base }}
      />
      <motion.div

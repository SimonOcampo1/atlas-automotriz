...
const tierTranslations: Record<Locale, Record<LogoTierId, TierStrings>> = {
  es: {
    "nivel-1": {
      ...
      description: "Las marcas mas famosas y masivas del mundo.",
      hint: "Aprendizaje ultra rapido.",
    ...
    "nivel-3": {
      ...
      description: "Muy vistas en mercados especificos.",
      hint: "Amplia el mapa cultural.",
    ...
    "nivel-7": {
      label: "Historicas y locales",
      description: "Marcas antiguas o de nicho regional.",
      hint: "Requiere investigacion adicional.",
...
const translations = {
  es: {
    ...
    "meta.description":
      "Explora un catalogo completo de logos de marcas de autos con filtros, orden y niveles de dificultad.",
    "language.switchToEnglish": "Cambiar a ingles",
    "language.switchToSpanish": "Cambiar a espanol",
    "hero.byAuthor": "Por Simon Ocampo",
    "hero.title": "Atlas automotriz",
    "hero.subtitle": "Descubre marcas iconicas y raras con una experiencia limpia y directa.",
    "hero.exploreCollection": "Explorar coleccion",
    "hero.learnByLevels": "Aprender por niveles",
    "footer.imageSource": "Fuente de imagenes: repositorio",
    "footer.carImagesSource": "Imagenes de autos tomadas de",
    "brands.explore": "Explorar marcas",
    "brands.countOf": "{current} de {total} marcas",
    "brands.fullCollection": "Coleccion completa",
    "search.nameOrSlug": "Buscar por nombre o slug",
    "sort.asc": "Orden ascendente (A-Z)",
    "sort.desc": "Orden descendente (Z-A)",
    "filter.resolution": "Resolucion",
    "filter.visualSize": "Tamano visual",
    "filter.columns": "Columnas",
    "filter.group": "Agrupar",
    "filter.groupLetters": "Agrupar por letras",
    "filter.groupCountries": "Agrupar por paises",
    "filter.allCountries": "Todos los paises",
    "filter.noCountry": "Sin pais",
    "filter.regions": "Regiones",
    "filter.countries": "Paises",
    "size.mini": "Mini",
    ...
    "dialog.originalSizeView": "Vista ampliada en tamano original.",
    ...
    "quiz.onlyMultiple": "Solo opcion multiple con 4 respuestas.",
    "quiz.onlyMultiplePerQuestion": "Solo opcion multiple con 4 respuestas por pregunta.",
    ...
    "sort.label": "Ordenar",
    "sort.yearOldest": "Ano: mas antiguo",
    "sort.yearNewest": "Ano: mas reciente",
    ...
    "learn.classicQuiz": "Quiz clasico",
